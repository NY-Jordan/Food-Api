        ...
        <div class="container">
            <nav class="nav bg-dark nav-bar" style="margin:00px; padding:10px; border-radius:10px;">
                <ul class="nav-items d-flex  m-0">
                    ...
                    <li class="nav nav-item " >
                        <form action="{{ route('search') }}" method="post" class="d-flex" style="margin-right: 80px;">
                            <input type="search" class="form-control" name="query" style=" width:400px; margin-left:10px; border-radius: 100px;" id="searchMenu1" placeholder="{{ $placeholderSearch :? 'que voulez-vous ?'}}">
